...
angular
  ...
  .config(function($translateProvider, $routeProvider, $httpProvider) {
    $routeProvider
      ...
      .when(
        '/dataSetReport/report/dataSet/:dataSet/orgUnit/:orgUnit/period/:period',
        {
          controller: 'ReportController',
          templateUrl: 'views/report.html'
        }
      ...
      .when(
        '/dataSetReport/report/dataSet/:dataSet/orgUnit/:orgUnit/period/:period/:preview',
        {
          controller: 'ReportController',
          templateUrl: 'views/report.html'
        }
      ...
      .when(
        '/dataSetReport/report/dataSet/:dataSet/orgUnit/:orgUnit/period/:period/:preview/:objectId',
        {
          controller: 'ReportController',
          templateUrl: 'views/report.html'
        }
      ...
      .when(
        '/dataSetReport/reportRequest/dataSet/:dataSet/orgUnit/:orgUnit/period/:period',
        {
          controller: 'ReportRequestController',
          templateUrl: 'views/reportRequest.html'
        }
